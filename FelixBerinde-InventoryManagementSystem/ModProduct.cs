...
namespace FelixBerinde_InventoryManagementSystem
{
    public partial class ModProduct : Form
    {
        ...
        public BindingList<Part> TempBindingList = new BindingList<Part>();
        ...
        public ModProduct(Product product)
        {
            InitializeComponent();
            dgvParts.DataSource = Inventory.AllParts;
            TempBindingList = product.AssociatedParts;
            dgvAssociatedParts.DataSource = TempBindingList;
            IDBox.ReadOnly = true;
            IDBox.Text = product.ProductID.ToString();
            nameBox.Text = product.Name.ToString();
            inventoryBox.Text = product.InStock.ToString();
            priceCostBox.Text = product.Price.ToString();
            maxBox.Text = product.Max.ToString();
            minBox.Text = product.Min.ToString();
        ...
        private void myAssociatedPartBindingComplete(object sender, DataGridViewBindingCompleteEventArgs e)
        {
        ...
        private void saveBtn_Click(object sender, EventArgs e)
        {
            ...
            Inventory.updateProduct(num, tempProduct);
